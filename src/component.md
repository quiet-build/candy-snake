...
The embedded focus/input container is div.game-container, not a main landmark. Standalone index.html retains its own main. Keep selectors aligned with the component regression tests.
