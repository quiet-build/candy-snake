...
The real three-life scene-tick and replay case has a local 45-second budget and advances the scene clock in 500ms slices until the real round event is observed, with the original 12-second simulated-time ceiling. This avoids rendering frames after game over while retaining all control, score, round and replay assertions.
