...
<script type="module">import 'http://127.0.0.1:5301/component.js';document.querySelector('#player').append(document.createElement('pma-candy-snake'));</script>`);
}).listen(5302,"127.0.0.1");
