...
const canonical = 'https://playminiarcade.com/game/candy-snake';
const legacy = 'snake.playminiarcade.com';
...
test('Pages, preview, local and lookalike hosts pass through unchanged', async () => {
  for (const url of ['https://candy-snake.pages.dev/component.js', 'https://preview.candy-snake.pages.dev/component.js', 'http://127.0.0.1:8788/component.js', `https://${legacy}.evil.example/`]) {
